                        ...
                        <div class="navbar-default sidebar" role="navigation">
                            <div class="sidebar-nav navbar-collapse">
                                <ul class="nav" id="side-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url("Adminc/requestreg"); ?>"><i class="fa fa-dashboard fa-fw"></i> Request of Registration</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="<?php echo site_url("Adminc/featuredsupplier"); ?>"><i class="fa fa-dashboard fa-fw"></i> Featured Supplier Management</a>
                                    </li>
                                    <!--                            <li>
                                                                    <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Request of Registration<span class="fa arrow"></span></a>
