        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="<?php echo site_url("Adminc/index"); ?>"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    <li>
                        <a class="active-menu" href="<?php echo site_url("Adminc/requestreg"); ?>"><i class="fa fa-desktop fa-3x"></i> Request of Registration</a>
                    </li>
                    <li>
